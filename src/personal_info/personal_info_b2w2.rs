...
pub struct PersonalInfoB2W2 {
    pub(super) child: PersonalInfoBW,
    tmhm: Vec<bool>,
...
impl PersonalInfo for PersonalInfoB2W2 {
    fn new(data: Vec<u8>) -> Self {
        Self {
            ...
            child: PersonalInfoBW::new_child(data),
        }
    }
    ...
    fn write(&mut self) -> Vec<u8> {
        set_bits(&mut self.child.data[0x28..], &self.tmhm);
        set_bits(&mut self.child.data[0x38..], &self.type_tutors);
        set_bits(&mut self.child.data[0x3C..], &self.special_tutors[0]);
        set_bits(&mut self.child.data[0x40..], &self.special_tutors[1]);
        set_bits(&mut self.child.data[0x44..], &self.special_tutors[2]);
        set_bits(&mut self.child.data[0x48..], &self.special_tutors[3]);
