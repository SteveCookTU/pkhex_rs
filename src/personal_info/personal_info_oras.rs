...
impl PersonalInfo for PersonalInfoORAS {
    ...
    fn write(&mut self) -> Vec<u8> {
        ...
        set_bits(&mut self.child.child.data[0x40..], &self.special_tutors[0]);
        set_bits(&mut self.child.child.data[0x44..], &self.special_tutors[1]);
        set_bits(&mut self.child.child.data[0x48..], &self.special_tutors[2]);
        set_bits(&mut self.child.child.data[0x4C..], &self.special_tutors[3]);
