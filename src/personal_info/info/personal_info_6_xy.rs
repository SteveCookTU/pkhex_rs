...
pub struct PersonalInfo6XY<'a> {
    data: &'a [u8],
    tmhm: Vec<bool>,
    type_tutors: Vec<bool>,
}

impl<'a> PersonalInfo6XY<'a> {
    pub const SIZE: usize = 0x40;

    pub fn new(data: &'a [u8]) -> PersonalInfo6XY<'a> {
        Self {
            data,
...
impl BaseStat for PersonalInfo6XY<'_> {
    fn hp(&self) -> u8 {
...
impl EffortValueYield for PersonalInfo6XY<'_> {
    fn ev_hp(&self) -> u8 {
...
impl GenderDetail for PersonalInfo6XY<'_> {
    fn gender(&self) -> u8 {
        self.data.default_read_le(0x12)
    }
}

impl PersonalFormInfo for PersonalInfo6XY<'_> {
...
impl PersonalAbility for PersonalInfo6XY<'_> {
...
impl PersonalAbility12 for PersonalInfo6XY<'_> {
...
impl PersonalAbility12H for PersonalInfo6XY<'_> {
    fn ability_h(&self) -> u16 {
        self.data.default_read_le::<u8>(0x1A) as u16
    }
}

impl PersonalEgg for PersonalInfo6XY<'_> {
...
impl PersonalEncounter for PersonalInfo6XY<'_> {
...
impl PersonalType for PersonalInfo6XY<'_> {
    fn type_1(&self) -> u8 {
...
impl PersonalMisc for PersonalInfo6XY<'_> {
...
impl PersonalInfo for PersonalInfo6XY<'_> {
