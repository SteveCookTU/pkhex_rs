...
pub struct PersonalInfo7GG<'a> {
    data: &'a [u8],
    tmhm: Vec<bool>,
    type_tutors: Vec<bool>,
}

impl<'a> PersonalInfo7GG<'a> {
    pub const SIZE: usize = 0x54;

    pub fn new(data: &'a [u8]) -> PersonalInfo7GG<'a> {
        Self {
            data,
...
impl BaseStat for PersonalInfo7GG<'_> {
    fn hp(&self) -> u8 {
...
impl EffortValueYield for PersonalInfo7GG<'_> {
    fn ev_hp(&self) -> u8 {
...
impl GenderDetail for PersonalInfo7GG<'_> {
    fn gender(&self) -> u8 {
        self.data.default_read_le(0x12)
    }
}

impl PersonalFormInfo for PersonalInfo7GG<'_> {
...
impl PersonalAbility for PersonalInfo7GG<'_> {
...
impl PersonalAbility12 for PersonalInfo7GG<'_> {
...
impl PersonalAbility12H for PersonalInfo7GG<'_> {
    fn ability_h(&self) -> u16 {
        self.data.default_read_le::<u8>(0x1A) as u16
    }
}

impl PersonalEgg for PersonalInfo7GG<'_> {
...
impl PersonalEncounter for PersonalInfo7GG<'_> {
...
impl PersonalType for PersonalInfo7GG<'_> {
    fn type_1(&self) -> u8 {
...
impl PersonalMisc for PersonalInfo7GG<'_> {
...
impl PersonalInfo for PersonalInfo7GG<'_> {
